...
- Colours, radius, shadows and type come from the tokens in `styles/globals.css`. No raw hex in a component. Visual rules: [design-language.md](./design-language.md).
